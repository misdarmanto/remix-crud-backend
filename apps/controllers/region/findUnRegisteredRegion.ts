  ...
  try {
    ...
    const result = await DesaModel.findAndCountAll({
      where: {
        ...
        ...(req.query.desaName && {
          desaName: { [Op.eq]: req.query.desaName }
        })
      },
      attributes: ['desaName'],
      include: [
        {
          ...
          where: {
            ...
            ...(req.query.kecamatanName && {
              kecamatanName: { [Op.eq]: req.query.kecamatanName }
            }),
            ...(req.query.search && {
              [Op.or]: [{ kecamatanName: { [Op.like]: `%${req.query.search}%` } }]
            })
          }
        },
        {
          ...
          where: {
            ...
            ...(req.query.kabupatenName && {
              kabupatenName: { [Op.eq]: req.query.kabupatenName }
            }),
            ...(req.query.search && {
              [Op.or]: [{ kabupatenName: { [Op.like]: `%${req.query.search}%` } }]
            })
          }
        }
      ],
